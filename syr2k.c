...
cublasSsyr2k(handle, CUBLAS_FILL_MODE_UPPER, CUBLAS_OP_T, N, N, &d_alpha, d_A, N, d_B, N, &d_beta, d_C, N);
...
int main(int argc, char **argv)
{
  ...
  float alpha = 1;
  float beta = 0;
  float a[3][3] = { -5, 7, -17, 8, 9, -13, -16, -11, 6};
  float b[3][3] = { -6, -13, -11, 9, -7, 14, -17, 8, -15}; //, 3, -1, -2, 5, 2, -1};
 // float b[3][3] = { -1, 3, -3, 0, -6, 5, -5, -3, 1};
  float res[3][3] = { 7, 0, 0, -17, 11, 0, -13, -12, 8};
